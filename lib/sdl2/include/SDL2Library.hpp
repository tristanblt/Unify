...
class SDL2Library : public DisplayLibrary {
    ...
    private:
        ...
        const int keys[101] = {SDLK_a, SDLK_b, SDLK_c, SDLK_d, SDLK_e, SDLK_f, SDLK_g, SDLK_h, SDLK_i, SDLK_j, SDLK_k, SDLK_l, SDLK_m, SDLK_n, SDLK_o, SDLK_p, SDLK_q, SDLK_r, SDLK_s, SDLK_t, SDLK_u, SDLK_v, SDLK_w, SDLK_x, SDLK_y, SDLK_z,
        ...
        SDLK_RIGHTBRACKET, SDLK_SEMICOLON, SDLK_COMMA, SDLK_PERIOD, SDLK_QUOTE, SDLK_SLASH, SDLK_BACKSLASH, SDLK_2, SDLK_EQUALS, SDLK_BACKQUOTE, SDLK_SPACE, SDLK_RETURN, SDLK_BACKSPACE, SDLK_TAB, SDLK_PAGEUP, SDLK_PAGEDOWN, SDLK_END,
